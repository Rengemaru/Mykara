...
export function seedIfEmpty(): void {
  ...
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (1, 83.5, '2026-03-18', 'DAM')");
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (1, 86.0, '2026-04-05', 'JOYSOUND')");
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (1, 89.2, '2026-04-22', 'JOYSOUND')");
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (1, 92.4, '2026-05-10', 'DAM')");
  ...
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (2, 84.3, '2026-04-10', 'DAM')");
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (2, 89.1, '2026-05-01', 'DAM')");
  ...
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (3, 80.2, '2026-03-01', 'DAM')");
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (3, 85.7, '2026-05-20', 'JOYSOUND')");

  // 曲4: カタオモイ（キーなし）
  db.runSync("INSERT INTO songs (title, artist, key_offset, created_at) VALUES ('カタオモイ', 'Aimer', NULL, ?)", [now]);
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (4, 88.3, '2026-05-15', 'DAM')");
  ...
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (5, 78.9, '2026-04-15', 'DAM')");
  db.runSync("INSERT INTO scores (song_id, score, scored_at, machine) VALUES (5, 83.2, '2026-05-22', 'JOYSOUND')");
}
